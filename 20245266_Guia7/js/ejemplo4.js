...
// ------------------------------------------------------------
// 2. Defina la función para crear el contenedor de la nueva página web.
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// 3. Función para clonar el menú principal hacia la página
// ------------------------------------------------------------
buttonMenu.onclick = function () {
    ...
    if (contenedor) {
        ...
        if (menuVerificar.length == 0) {
            // Clonando el menu principal de la pagina
...
// ------------------------------------------------------------
// 4. Función para crear títulos en nuestra página web.
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// 5. Función para crear párrafos en nuestra página web.
// ------------------------------------------------------------
